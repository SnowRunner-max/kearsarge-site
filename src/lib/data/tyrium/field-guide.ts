...
**Extraction & Transport:** Triple-gasket transport crates with vibration isolation pods, with liquid Tyrium moved in cryo-stabilized ampoules housed inside Faraday-lined casings.

**Field PPE:** Two-layer suits with solvent-lined inner membranes for liquid exposures, paired with powered respirators featuring Tyrium-specific HEPA and catalytic scrubbers for vapor. Exposure limit: 30 minutes for crystalline or refined material and 10 minutes for airborne or liquid proximity operations, revised based on incident calibration.

**Decon:** Immediate neutralization agents for liquid contact (see Appendix — Solvent Formulae). Do not attempt surgical excision on recently infused tissue without Aurora-approved dampener implants.

**Quarantine & Psychological Intervention:** Any subject with patterned luminescence enters Level-3 Quarantine. Conduct psychological screening for fixation and compulsion, and initiate early cognitive-dampening protocols when indicated.

**Use-of-Force:** Infused organisms are considered both high-value subjects and high-risk vectors. **Do not** terminate without Aurora authorization; destructive measures are a last resort to prevent contagion spread.
...
**Spectro-Resonant Scan (SRS):** Detects lattice harmonics and differentiates between crystalline, refined, and liquid signatures.
